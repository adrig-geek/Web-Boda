...
const TRANSLATIONS = {
  ca: {
    ...
    'nav-details':  'Detalls',
    'nav-rsvp':     'Confirma la teva assistència',
    ...
    'story-p1': 'La nostra història va començar fa més de 12 anys, quan teníem 16. Sobreviure junts a l\'adolescència ja té mèrit, però créixer i descobrir el món de la mà ha estat, sens dubte, la millor de les aventures. Pel camí ens hem convertit en "els mivis", formant un equip on ens complementem de manera molt natural: l\'Adri és la part més reflexiva, qui aporta una mica d\'ordre i té ànima nocturna; mentre que l\'Èlia posa l\'espurna de la improvisació, es deixa portar més pel cor i és la primera a aprofitar els matins. Al final, hem trobat el nostre propi equilibri.',
    ...
    'story-p3': 'Després de tot el que hem compartit i construït junts en aquest temps, casar-nos era la peça que ens faltava al taulell. Potser la nostra història no és el guió d\'una pel·lícula de Hollywood, però per a nosaltres és senzillament perfecta.',
    ...
    'rsvp-att-label':      'Podràs acompanyar-nos?',
    ...
    'rsvp-child-notice':   'L\'Èlia o l\'Adri us contactaran per saber si el nen/a vol menú, i de quin tipus. Gràcies!',

    // Timeline
    'timeline-label':      'El dia',
    'timeline-title':      'El programa',
    'tl-0-title':  'Obertura de portes',
    'tl-0-desc':   'Benvinguda als convidats',
    ...
    'news-3-body':  'El codi de vestimenta és formal i elegant.<br>Teniu en compte que part de la celebració podrà ser a l\'aire lliure.',
    'news-3-note':  'Per cedir el protagonisme als nuvis, us demanem un petit favor: eviteu el blanc.',

    // FAQ
    'faq-heading': 'Preguntes freqüents',
    'faq-1-q': 'Hi ha aparcament a Can Ribas?',
    'faq-1-a': 'Sí, Can Ribas de Montbui disposa d\'aparcament gratuït pels convidats. Us recomanem arribar uns minuts abans per aparcar còmodament.',
    'faq-2-q': 'Poden assistir nens i nenes?',
    'faq-2-a': 'Sí, els nens i les nenes són benvinguts. Si veniu amb nens, indiqueu-ho al <a href="#rsvp">formulari de confirmació d\'assistència</a> perquè puguem organitzar-ho.',
    ...
    'faq-4-q': 'Què passa si tinc alguna al·lèrgia o dieta especial?',
    'faq-4-a': 'No us preocupeu per res! Per a nosaltres la vostra tranquil·litat és fonamental, i la cuina de Can Ribas és molt professional en aquest tema. Només heu d\'indicar-ho al <a href="#rsvp">formulari de confirmació d\'assistència</a> i l\'equip prepararà un menú segur i adaptat per a vosaltres.',
  ...
  es: {
    ...
    'rsvp-att-label':      '¿Podrás acompañarnos?',
    ...
    'rsvp-cal-google':     'Google Calendar',
    'rsvp-cal-apple':      'Apple / Outlook',
    'rsvp-child-notice':   'Èlia o Adri os contactarán para saber si el niño/a quiere menú, y de qué tipo. ¡Gracias!',
    ...
    'news-3-body':  'El código de vestimenta es formal y elegante.<br>Tened en cuenta que parte de la celebración podrá ser al aire libre.',
    'news-3-note':  'Para ceder el protagonismo a los novios, os pedimos un pequeño favor: evitad el blanco.',
    ...
    'faq-2-a': 'Sí, los niños/as son bienvenidos. Si venís con niños, indicadlo en el <a href="#rsvp">formulario de confirmación de asistencia</a> para que podamos organizarlo.',
    ...
    'faq-4-q': '¿Qué pasa si tengo alguna alergia o dieta especial?',
    'faq-4-a': '¡No os preocupéis por nada! Para nosotros vuestra tranquilidad es fundamental, y la cocina de Can Ribas es muy profesional y cuidadosa con este tema. Solo tenéis que indicarlo en el <a href="#rsvp">formulario de confirmación de asistencia</a> y el equipo preparará un menú seguro y adaptado para vosotros.',
